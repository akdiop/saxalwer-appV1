...
const BASE_ARTICLES: Article[] = [
	...
	{
		id: 101,
		category: 'Douleurs gynécologiques',
		categoryWo: 'Metit yu jigéen',
		lifeStage: 'Symptômes',
		lifeStageWo: 'Firnde',
		lifeSituations: ['general', 'curious'],
		ageRange: 'all',
		title: 'Comprendre les douleurs pelviennes',
		titleWo: 'Xam metit yu biir bi',
		description:
			"Douleurs de règles, douleurs pendant les rapports ou douleurs au bas-ventre : ce qui est courant, et les signaux qui doivent amener à consulter.",
		descriptionWo:
			"Metitu weer, metit ci jëkkër walla metit ci suuf biir : lu xew bu baax, ak firnde yi war la indil ci jël konsultation.",
		stage: 'young',
		audio: false,
		readTime: '6 min',
		author: 'Équipe SaxalWér — revu par une sage-femme',
		authorWo: 'Ekib SaxalWér — sage-femme moo ko seetlu',
		rating: 4.8,
		readers: 0,
		featured: false,
		tags: ['Douleurs', 'Règles', 'Bas-ventre', 'Consultation'],
		tagsWo: ['Metit', 'Weer', 'Biir', 'Konsultation'],
		content: [
			{ type: 'heading', fr: 'Une douleur n\u2019est pas toujours « normale »', wo: 'Metit du dañu ci yemale' },
			{
				type: 'text',
				fr: "Des douleurs légères pendant les règles sont fréquentes. Mais une douleur intense, qui t\u2019empêche d\u2019aller à l\u2019école ou au travail, qui revient en dehors des règles ou pendant les rapports, mérite l\u2019avis d\u2019une professionnelle de santé. Ce n\u2019est pas « dans la tête » et ce n\u2019est pas une fatalité.",
				wo: "Metit bu woyof ci weer dafa bare. Waaye metit bu metti, bu lay tere dem ekool walla liggéey, bu di dellusi ci biti weer walla ci jëkkër, war na am avis u jiganaaw wér-gi-yaram. Du « ci xel » te du yoon bu àndul ak saxal.",
			},
			{
				type: 'text',
				fr: "Les causes possibles sont nombreuses (règles douloureuses, infections, kystes, endométriose…). Seule une consultation permet d\u2019en identifier l\u2019origine. En attendant, repos, chaleur sur le bas-ventre et hydratation peuvent soulager.",
				wo: "Lu mën a indi metit bare na (weer wu metti, feebar, kist, endométriose…). Konsultation rekk mooy mën a xam lu ko waral. Ci diggante bi, noflaay, tàngoor ci suuf biir ak ndox mën nañu la dimbali.",
			},
		],
	},
	{
		id: 102,
		category: 'Pertes vaginales',
		categoryWo: 'Setu jigéen',
		lifeStage: 'Corps',
		lifeStageWo: 'Yaram',
		lifeSituations: ['general', 'curious'],
		ageRange: 'all',
		title: 'Les pertes vaginales : ce qui est normal',
		titleWo: 'Setu jigéen : lu baax',
		description:
			"Les pertes changent au fil du cycle. Apprends à distinguer ce qui est habituel des signes d\u2019une possible infection.",
		descriptionWo:
			"Setu jigéen dafay soppiku ci weer bi. Jàngal ràññee lu baax ak firnde u feebar bu mën am.",
		stage: 'young',
		audio: false,
		readTime: '5 min',
		author: 'Équipe SaxalWér — revu par une sage-femme',
		...
		readers: 0,
		featured: false,
		tags: ['Pertes', 'Hygiène intime', 'Infections', 'Cycle'],
		tagsWo: ['Set', 'Setal yaram', 'Feebar', 'Weer'],
		content: [
			{ type: 'heading', fr: 'Des pertes, c\u2019est sain', wo: 'Set, dafa wér' },
			{
				type: 'text',
				fr: "Le vagin se nettoie naturellement : des pertes claires ou blanchâtres, sans forte odeur, sont normales et varient pendant le cycle. Elles protègent ta santé intime.",
				wo: "Vagin dafay setal boppam : set bu leer walla bu weex, bu amul xeeñ bu metti, dafa baax te dafay soppiku ci weer bi. Dañuy aar sa wér-gi-yaram intime.",
			},
			{
				type: 'text',
				fr: "Consulte si les pertes changent nettement : odeur forte, couleur jaune/verte, démangeaisons, brûlures ou douleurs. Ce sont des signes possibles d\u2019infection, qui se soigne bien quand on consulte tôt. Évite les douches vaginales et les savons agressifs.",
				wo: "Konsulte su set bi soppikoo bu baax : xeeñ bu metti, melo mu mboq/wert, xasaw, lakk walla metit. Firnde u feebar lañu, bu ñu ko faj bu baax su nga konsulte ci njëkk. Bañal duuj vagin ak savon yu metti.",
			},
		],
	},
	{
		id: 103,
		category: 'Sexualité & rapports',
		categoryWo: 'Séy ak jëkkër',
		lifeStage: 'Intimité',
		lifeStageWo: 'Intimite',
		lifeSituations: ['general', 'curious'],
		ageRange: 'all',
		title: 'Sexualité : confort, consentement et santé',
		titleWo: 'Séy : neexal, ndigal ak wér-gi-yaram',
		description:
			"Consentement, confort et protection : les bases d\u2019une sexualité vécue sereinement et en bonne santé.",
		descriptionWo:
			"Ndigal, neexal ak aar : pexe yu mag ci séy bu jàmm ak wér-gi-yaram.",
		stage: 'young',
		audio: false,
		readTime: '6 min',
		author: 'Équipe SaxalWér — revu par une professionnelle de santé',
		authorWo: 'Ekib SaxalWér — jiganaaw wér-gi-yaram moo ko seetlu',
		rating: 4.8,
		readers: 0,
		featured: false,
		tags: ['Sexualité', 'Consentement', 'Protection', 'IST'],
		tagsWo: ['Séy', 'Ndigal', 'Aar', 'IST'],
		content: [
			{ type: 'heading', fr: 'Le consentement d\u2019abord', wo: 'Ndigal ci njëkk' },
			{
				type: 'text',
				fr: "Une relation se vit librement, sans contrainte ni pression. Tu as le droit de dire non à tout moment. Le consentement se donne, se retire, et se respecte des deux côtés.",
				wo: "Séy dafa wara am ci coobareek bopp, amul forse walla pexpe. Am nga sañ-sañu wax déedéet ci saa su nekk. Ndigal dañu koy jox, dañu koy delloo, te dañu koy faaydaal ñaari wëtt yi.",
			},
			{
				type: 'text',
				fr: "La douleur pendant les rapports n\u2019est pas normale : sécheresse, infection ou autre cause peuvent l\u2019expliquer, et une professionnelle peut aider. Le préservatif reste le seul moyen de se protéger à la fois d\u2019une grossesse non désirée et des IST.",
				wo: "Metit ci jëkkër dafa baaxul : wow, feebar walla leneen mën koo waral, te jiganaaw mën na dimbali. Préservatif mooy rekk doole bu lay aar ci ëmb bu nga bëggul ak IST yi.",
			},
		],
	},
	{
		id: 104,
		category: 'Col & dépistage',
		categoryWo: 'Bopp matrice ak saytu',
		lifeStage: 'Prévention',
		lifeStageWo: 'Aar',
		lifeSituations: ['general', 'curious'],
		ageRange: 'all',
		title: 'Santé du col de l\u2019utérus et dépistage',
		titleWo: 'Wér-gi-yaram bopp matrice ak saytu',
		description:
			"Le cancer du col se prévient et se dépiste. Comprendre le rôle du HPV, du vaccin et du frottis pour se protéger tôt.",
		descriptionWo:
			"Cancer bopp matrice mën nañu ko fagaru te saytu ko. Xam HPV, vaksen ak frottis ngir aar sa bopp ci njëkk.",
		stage: 'mature',
		audio: false,
		readTime: '7 min',
		author: 'Équipe SaxalWér — revu par une gynécologue',
		authorWo: 'Ekib SaxalWér — gynécologue moo ko seetlu',
		rating: 4.9,
		readers: 0,
		featured: false,
		tags: ['Col', 'Dépistage', 'HPV', 'Prévention'],
		tagsWo: ['Bopp matrice', 'Saytu', 'HPV', 'Aar'],
		content: [
			{ type: 'heading', fr: 'Un cancer qu\u2019on peut prévenir', wo: 'Cancer bu ñu mën a fagaru' },
			{
				type: 'text',
				fr: "Le cancer du col de l\u2019utérus est l\u2019un des plus fréquents chez la femme, mais aussi l\u2019un des plus évitables. Il est lié à un virus courant, le HPV, qui se transmet par contact intime.",
				wo: "Cancer bopp matrice mooy benn ci yi gën a bare ci jigéen, waaye it benn ci yi gën a yomb a moytu. Dafa jëm ak virus bu bare, HPV, biy wàllu ci laqu intime.",
			},
			{
				type: 'text',
				fr: "Deux gestes protègent : le vaccin contre le HPV (recommandé chez les jeunes filles) et le dépistage régulier (frottis ou test HPV) à partir de l\u2019âge conseillé par une professionnelle. Détecté tôt, il se soigne très bien.",
				wo: "Ñaari mbir ñoo lay aar : vaksen HPV (ñu koy digal ci janq yi) ak saytu bu sax (frottis walla test HPV) li dale ci àtte bu jiganaaw digal. Su ñu ko gis ci njëkk, dañu koy faj bu baax lool.",
			},
		],
	},
	{
		id: 105,
		category: 'Vulve & santé intime',
		categoryWo: 'Vulve ak setal yaram',
		lifeStage: 'Corps',
		lifeStageWo: 'Yaram',
		lifeSituations: ['general', 'curious'],
		ageRange: 'all',
		title: 'Vulve et hygiène intime',
		titleWo: 'Vulve ak setal yaram intime',
		description:
			"Mieux connaître son corps et adopter une hygiène intime douce, sans gestes agressifs qui fragilisent.",
		descriptionWo:
			"Gën a xam sa yaram te jëfandikoo setal yaram bu woyof, bañ jëf yu metti yiy yàq.",
		stage: 'young',
		audio: false,
		readTime: '5 min',
		author: 'Équipe SaxalWér — revu par une sage-femme',
		...
		readers: 0,
		featured: false,
		tags: ['Vulve', 'Hygiène intime', 'Corps', 'Bien-être'],
		tagsWo: ['Vulve', 'Setal yaram', 'Yaram', 'Jàmm'],
		content: [
			{ type: 'heading', fr: 'La douceur avant tout', wo: 'Woyof ci lu jëkk' },
			{
				type: 'text',
				fr: "La vulve a un équilibre naturel qui la protège. Pour en prendre soin, l\u2019eau et un nettoyage externe doux suffisent : pas de douche vaginale interne, pas de savon parfumé ou agressif, qui déséquilibrent et favorisent les infections.",
				wo: "Vulve am na ndaje bu am ci boppam biy ko aar. Ngir toppatoo ko, ndox ak setal bu woyof ci biti doy na : bañ duuj ci biir, bañ savon bu xeeñ walla bu metti, yiy yàq ndaje bi te indi feebar.",
			},
			{
				type: 'text',
				fr: "Consulte en cas de rougeurs, démangeaisons persistantes, gonflement ou douleur. Ce sont des signes courants et qui se soignent — il n\u2019y a aucune honte à en parler à une professionnelle.",
				wo: "Konsulte su amee xonq, xasaw bu sax, newet walla metit. Firnde yu bare lañu te ñu koy faj — amul gàcce ci wax ko jiganaaw.",
			},
		],
	},
	{
		id: 106,
		category: 'Urgences gynécologiques',
		categoryWo: 'Aajo yu jigéen',
		lifeStage: 'Urgence',
		lifeStageWo: 'Aajo',
		lifeSituations: ['general', 'curious'],
		ageRange: 'all',
		title: 'Reconnaître une urgence gynécologique',
		titleWo: 'Ràññee aajo bu jigéen',
		description:
			"Certains signes imposent de consulter sans attendre. Savoir les reconnaître et qui appeler au Sénégal.",
		descriptionWo:
			"Am na firnde yu lay tax konsulte ci saa si. Xam leen ak ku ngay woo ci Senegaal.",
		stage: 'mature',
		audio: false,
		readTime: '5 min',
		author: 'Équipe SaxalWér — revu par une professionnelle de santé',
		...
		readers: 0,
		featured: false,
		tags: ['Urgence', 'Saignement', 'Douleur intense', 'SAMU'],
		tagsWo: ['Aajo', 'Deret', 'Metit bu metti', 'SAMU'],
		content: [
			{ type: 'heading', fr: 'Ne pas attendre', wo: 'Bañ a xaar' },
			{
				type: 'warning',
				fr: "Consulte en urgence en cas de : douleur abdominale brutale et intense, saignement abondant qui ne s\u2019arrête pas, fièvre élevée avec douleurs du bas-ventre, malaise ou perte de connaissance, ou douleur intense en étant peut-être enceinte.",
				wo: "Konsulte ci aajo su amee : metit bu biir bu jaadu te metti, deret bu bare bu taxawul, tàngoor bu kawe ak metit suuf biir, mer-mer walla ngëlén, walla metit bu metti su mën nga di ëmb.",
			},
			{
				type: 'text',
				fr: "Au Sénégal, en cas d\u2019urgence : SAMU 1515, Pompiers 18, Police 17. N\u2019hésite pas à te faire accompagner et à te rendre dans l\u2019établissement de santé le plus proche.",
				wo: "Ci Senegaal, su amee aajo : SAMU 1515, Sapër-pompier 18, Polis 17. Bul ñàkk ñu ànd ak yaw te dem fu gën a jege u loppitaan.",
			},
		],
	},
	{
		...
		categoryWo: 'Fagaru ak saytu',
		lifeStage: 'Prévention',
		lifeStageWo: 'Fagaru',
		lifeSituations: ['general', 'curious'],
		ageRange: 'all',
		title: 'Prévention et dépistages essentiels',
		titleWo: 'Fagaru ak saytu yu am solo',
		description:
			"Visites régulières, vaccins et dépistages : les rendez-vous qui protègent ta santé sur le long terme.",
		descriptionWo:
			"Visit yu sax, vaksen ak saytu : ndaje yiy aar sa wér-gi-yaram ci àdduna bu gudd.",
		stage: 'mature',
		audio: false,
		readTime: '6 min',
		author: 'Équipe SaxalWér — revu par une professionnelle de santé',
		...
		readers: 0,
		featured: false,
		tags: ['Prévention', 'Dépistage', 'Vaccins', 'Suivi'],
		tagsWo: ['Fagaru', 'Saytu', 'Vaksen', 'Toppatoo'],
		content: [
			{ type: 'heading', fr: 'Prévenir, c\u2019est se protéger', wo: 'Fagaru, mooy aar sa bopp' },
			{
				type: 'text',
				fr: "La prévention ne sert pas qu\u2019aux malades : un suivi régulier permet de repérer tôt et d\u2019éviter beaucoup de problèmes. Selon ton âge, une professionnelle peut te conseiller des dépistages adaptés.",
				wo: "Fagaru du ngir ñiy feebar rekk : toppatoo bu sax dafay tax ñu gis ci njëkk te moytu jafe-jafe yu bare. Ci sa at, jiganaaw mën na la digal saytu yu jaadu.",
			},
			{
				type: 'text',
				fr: "Quelques repères utiles : vaccins recommandés (HPV, hépatite B), dépistage des IST en cas de besoin, attention à sa poitrine et au col selon l\u2019âge. Une seule règle : en parler avec une professionnelle de confiance.",
				wo: "Ay firnde yu am njariñ : vaksen yu ñu digal (HPV, hépatite B), saytu IST su soxla, gëstu sa wën ak bopp matrice ci sa at. Benn yoon rekk : waxal ko ak jiganaaw bu nga wóolu.",
			},
		],
	},
	{
		id: 108,
		category: 'Bien-être & corps',
		categoryWo: 'Jàmm ak yaram',
		lifeStage: 'Bien-être',
		lifeStageWo: 'Jàmm',
		lifeSituations: ['general', 'curious'],
		ageRange: 'all',
		title: 'Bien-être, corps et estime de soi',
		titleWo: 'Jàmm, yaram ak xam-sa-bopp',
		description:
			"Connaître son corps, prendre soin de son sommeil, de son alimentation et de son moral : le bien-être au quotidien.",
		descriptionWo:
			"Xam sa yaram, toppatoo sa nelaw, sa lekk ak sa xel : jàmm ci bés bu nekk.",
		stage: 'young',
		audio: false,
		readTime: '6 min',
		author: 'Équipe SaxalWér',
		authorWo: 'Ekib SaxalWér',
		rating: 4.7,
		readers: 0,
		featured: false,
		tags: ['Bien-être', 'Corps', 'Sommeil', 'Estime de soi'],
		tagsWo: ['Jàmm', 'Yaram', 'Nelaw', 'Xam-sa-bopp'],
		content: [
			{ type: 'heading', fr: 'Ton corps mérite de l\u2019attention', wo: 'Sa yaram yelloo na ngeen koy topptoo' },
			{
				type: 'text',
				fr: "Connaître son corps, c\u2019est déjà en prendre soin. Un sommeil suffisant, une alimentation variée, un peu d\u2019activité et des moments de repos aident le corps et l\u2019esprit à tenir.",
				wo: "Xam sa yaram, mooy toppatoo ko. Nelaw bu doy, lekk bu wuute, tuuti tàggat-yaram ak jamono u noflaay dañuy dimbali yaram ak xel ngir ñu sax.",
			},
			{
				type: 'text',
				fr: "Le bien-être, c\u2019est aussi le moral : se sentir triste, stressée ou dépassée arrive à tout le monde. En parler à une personne de confiance ou à une professionnelle n\u2019est pas une faiblesse, c\u2019est prendre soin de soi.",
				wo: "Jàmm, mooy itam xel : yëg naqar, tiis walla coono dafay dal ñépp. Wax ko nit ku nga wóolu walla jiganaaw du néew-doole, mooy toppatoo sa bopp.",
			},
		],
	},
];
