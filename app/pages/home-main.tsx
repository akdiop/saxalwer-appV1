...
const TESTIMONIALS = [
  {
    quote: 'Pour la première fois, je comprends mes douleurs sans honte.',
    author: 'Aminata, 24 ans',
  },
  {
    quote: 'Le mode discret m’a aidée à garder mon intimité au quotidien.',
    author: 'Fatou, 31 ans',
  },
  {
    quote: 'Les explications sont douces, concrètes et jamais culpabilisantes.',
    author: 'Ndèye, 42 ans',
  },
];
